...
using Service.WalletApi.EducationSecurityApi.Controllers.Contracts;
using Service.WalletApi.EducationSecurityApi.Mappers;
using Service.Web;

namespace Service.WalletApi.EducationSecurityApi.Controllers
{
	[Route("/api/v1/education/security")]
	public class EducationController : BaseController
	{
		private readonly IGrpcServiceProxy<ITutorialSecurityService> _tutorialService;

		public EducationController(IGrpcServiceProxy<ITutorialSecurityService> tutorialService,

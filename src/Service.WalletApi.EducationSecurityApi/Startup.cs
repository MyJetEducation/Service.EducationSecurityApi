...
using Service.WalletApi.EducationSecurityApi.Modules;

namespace Service.WalletApi.EducationSecurityApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/security");

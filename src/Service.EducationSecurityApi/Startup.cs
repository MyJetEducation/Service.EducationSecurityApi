...
using Service.EducationSecurityApi.Modules;
using Service.Web;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.EducationSecurityApi
{
	public class Startup
	{
		private const string DocumentName = "education/security";
		private const string ApiName = "EducationSecurityApi";
